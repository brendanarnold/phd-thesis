...
\begin{figure}[htbp]
    \begin{center}
        ...
        \caption{A schematic illustration of the mechanism of spin fluctuation mediated pairing. Two itinerant electrons (empty circles) are bound via exchange interactions, $J$, to two electrons coupled by an antiferromagnetic spin fluctuation (large dotted line). Adapted from ref.~\cite{Cox1995}}
