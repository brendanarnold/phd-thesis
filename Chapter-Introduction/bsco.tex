...
\subsection{Motivation for high-field transport measurements on \ac{BSCO}}
    \label{Sec:Intro:MotivationBSCO}
...
By examining the temperature dependence of Hall data down to \unit{1.4}{\kelvin} in \ac{BSCO} we can determine if a model based on the Ong construction and anisotropic scattering can explain the low temperature Hall behaviour in \ac{BSCO} similar to what was shown for \ac{LSCO}~\cite{Narduzzo2008}. This will help determine whether the geometric arguments provided by Ong apply more generally to the cuprates and whether it is therefore necessary to invoke the complex Fermi surface re-construction scenario described by LeBoeuf \etal{} to describe the behaviour of $R_H$ in the cuprates.
...
The samples were grown by Prof. Takeuchi's group in Sendai University, Japan in May 2009. The high field data was obtained on three separate occasions. The first \acs{LNCMI}, Toulouse results were obtained by the author with the help of Dr. P. Rourke, Dr. B. Vignolle and Dr. C. Proust. The second set of \acs{LNCMI} results were obtained by Dr. P. Rourke, Dr. J-F. Mercure, N. Wakeham, Prof. N. Hussey with the help of Dr. B. Vignolle and Dr. C. Proust. Finally the data from \acs{HFML}, Nijmegen was taken by Dr. P. Rourke, I. Mouzoupoulou, Dr. X. Xu and Dr. A. McCollum. The low field data taken in the `Polo magnet' at Bristol and all the analysis was performed by the author. The investigations described in this section are undertaken in chapter~\ref{Sec:HallBSCO}.
