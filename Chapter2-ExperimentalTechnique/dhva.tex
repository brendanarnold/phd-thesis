...
\end{equation}
%%
and is known as the \textit{cyclotron frequency}. By substituting the above into equation\ref{Eqn:2:OscillateE} and plotting as a function of field, we obtain the energy oscillations shown in \fig\ref{Fig:2:EnergyOscillations}.
%%
\begin{figure}[htbp]
    \begin{center}
