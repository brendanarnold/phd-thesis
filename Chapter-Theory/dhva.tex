...
The rate of change of the gradient of the energy dispersion along the electron orbit therefore affects the oscillation amplitude and is accounted for in the second derivative term in equation~\ref{Eqn:Theo:LKM}. The flatter the dispersion, the larger this term will be. In the limiting case where the dispersion in $k_\perp$ is effectively flat close to the orbit then we get the `Yamaji condition'~\cite{Yamaji1989}, and the oscillations are greatly enhanced.
...
\subsection{Final theoretical observations}
    \label{Sec:Theo:TheoreticalObservations}
