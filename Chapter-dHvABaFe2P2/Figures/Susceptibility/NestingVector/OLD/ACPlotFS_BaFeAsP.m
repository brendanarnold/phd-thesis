function ACPlotFS(fs,Shift,orbit_nums);

pvol = fs.BZfacenormals*fs.rlvs;

ka = 1.2;
% kz = 2 * pi / fs.latt_params(3);
kz = 4 * pi / fs.latt_params(3);
k1 = fs.rlvs(1,2) ./ 2
k2 = k1 / 2;

disp(['Fermi Level Shift ' num2str(Shift) ' Ry'])
pvol2=[ka 0 0; 0 ka 0; 0 0 kz; -ka 0 0; 0 -ka 0; 0 0 -kz; k1 k1 0];
pvol3=[-k1/2 0 0; 0 -k1.*1.5 0; 0 0 kz; eps eps 0; 0 0 -kz;];
...
if ismember(4, orbit_nums)
    plot_FS(fs,[4],fs.FermiLevel+Shift(4),colors(5,:),[],pvol3,[],[],[], ...
        'linear',gca,true);
end
