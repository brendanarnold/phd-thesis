...
Using the $T_c$ values obtained from figure~\ref{Fig:ResH:Tsweeps} we can determine the doping assignments according the parabola in Presland \etal~\cite{Presland1991}. This is then compared with the doping assignments which we make by matching $R_H(\unit{300}{\kelvin})$ in the \ac{BSCO} data from the previous section with that compiled in Kokalj \etal~\cite{Kokalj2012} on \ac{TL2201}. The results of this comparison are shown in figure~\ref{Fig:ResH:DopingRh300}.
\begin{figure}[htbp]
    \begin{center}
