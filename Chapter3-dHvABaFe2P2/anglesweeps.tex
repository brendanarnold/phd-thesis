...
\begin{figure}[htbp]
    \begin{center}
        \includegraphics[scale=0.95]{Chapter3-dHvABaFe2P2/Figures/AngleDepMeasurements/ShiftedBandStructure/ShiftedBandStructure}
        ...
        \label{Fig:3:ShiftedBandStructure}
    \end{center}
\end{figure}
